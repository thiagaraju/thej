...
public class BDC_Demo_01_defenitions {
	@Given("user launch demowebshop app in chrome browser")
	public void user_launch_demowebshop_app_in_chrome_browser() {
	    // Write code here that turns the phrase above into concrete actions
	    //throw new cucumber.api.PendingException();
	}

	@Then("user user searches for the item of his choice")
	public void user_user_searches_for_the_item_of_his_choice() {
	    // Write code here that turns the phrase above into concrete actions
	    //throw new cucumber.api.PendingException();
	}
